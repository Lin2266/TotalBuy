...
public class CustomersDAO implements DAOInterface<String, Customer> {
    ...
    public void insert(Customer data) throws TotalBuyException {
        //2.get Connection
        try (Connection connection = RDBConnection.getConnection();//RDBC是連線池
                //Connection connection2 = DriverManager.getConnection(SELECT_SQL);一般驅動連線
            ...
            pstmt.setDate(6, data.getBirthDate() == null ? null : new java.sql.Date(
                    data.getBirthDate().getTime()));
